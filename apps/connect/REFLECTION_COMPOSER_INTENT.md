...
- **Choose delivery** — after speaking, **Clean caption** is the default (Explorer hears polished AI TTS). Switch to **My voice** only if you want them to hear the raw recording.
...
4. By default the Explorer hears **Clean caption** (AI TTS). Companion may switch to **My voice**.
...
Most new Reflections will be quick: pick media → glance Workbench → Sparkle → **tap mic and talk** → land on cleaned context + caption with **Clean caption** selected → hear Rich Narration → Finish → Send.
...
A Companion sits down with a video of the Explorer's grandmother visiting. They trim to the moment Nona walks through the door. They set the poster frame to her smiling face. They tap Tell the story: "Hey buddy, look — that's Nona, uh, she just got here, Dalton's going crazy." Sparkle cleans it, drafts a warm caption, and a Rich Narration that actually knows Nona. They keep **Clean caption** (or switch to **My voice** when they want their own recording to play). They preview — poster, video, back to Nona's smile, then the caption voice — and it is *perfect*. They send.
